...
\textsc{\large \url{https://git.io/J39ZB}}\\[0.5cm] % Minor heading such as course title
...
Une documentation des classes et des méthodes est disponible en annexe sous format PDF, elle a été rédigée en anglais dans le style numpy. Une version HTML est aussi disponible sur \url{https://github.com/davidPinaud/PANDROIDE_InfDiag_BandB/tree/master/docs/documentation}
...
Voici un exemple (très simple) où un élagage a pu être fait :
\begin{figure}[ht]
\centering
\begin{subfigure}{.5\textwidth}
  \centering
